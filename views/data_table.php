                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tabla de Datos con características mínimas y estilo de desplazamiento</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title">Tabla de datos con características predeterminadas</h3>
                                </div>
                                <!-- /.card-header -->
                                <div class="card-body">
